    ...
    <div className="space-y-8">
      ...
      <div className="bg-yellow-50 border border-yellow-400 p-4 rounded-md mb-6">
        <p className="text-sm text-yellow-800">
          ...
          your application. You will not be able to edit this information after
          submission.
        </p>
      </div>
          ...
          <div className="pt-2">
            ...
            {formData.preferredPlacements.length > 0 ? (
              ...
              <p className="text-sm text-gray-500 italic mt-2">
                No preferred placements specified
              </p>
            )}
          </div>
        </div>
          ...
          <div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {formData.academicQualifications.map(
                    (qualification, index) => (
                      <tr key={index}>
          ...
          <div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {formData.professionalQualifications.map(
                    (qualification, index) => (
                      <tr key={index}>
                        <td className="px-3 py-2 text-sm text-gray-900">
              ...
              <div>
                ...
                <div className="mt-1 grid grid-cols-1 md:grid-cols-4 gap-4">
                  <div>
                    ...
                    <p className="text-sm">
                      {formData.workExperience.present.position || "-"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">From</p>
                    <p className="text-sm">
                      {formData.workExperience.present.from || "-"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">To</p>
                    <p className="text-sm">
                      {formData.workExperience.present.to || "-"}
                    </p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-400">Years</p>
                    <p className="text-sm">
                      {formData.workExperience.present.years || "-"}
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="border-t border-gray-200 pt-4">
        <div className="flex items-center justify-center">
          <p className="text-sm text-gray-500 italic">
            By clicking "Submit Application", you agree that all the information
