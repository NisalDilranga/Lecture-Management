...
const ExperienceStep = ({ formData, updateFormData, setStepValid }) => {
  ...
  useEffect(() => {
    ...
    const isTeachingExperienceValid =
      noTeachingExperience ||
      formData.teachingExperience.some(
        (exp) =>
          exp.institute.trim() !== "" &&
          exp.program.trim() !== "" &&
          exp.subject.trim() !== "" &&
    ...
    const isPastWorkValid = formData.workExperience.past.every(
      (exp) =>
        (exp.position.trim() === "" &&
          exp.from.trim() === "" &&
          exp.to.trim() === "" &&
    ...
    const isValid =
      isPresentWorkValid && isTeachingExperienceValid && isPastWorkValid;
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleWorkExperienceChange("present", "from", e.target.value)
                }
                className="mt-1 pl-2 block w-full rounded-md border border-gray-600 shadow-sm focus:border-[#8B0000] focus:ring-[#8B0000] h-10"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleWorkExperienceChange("present", "to", e.target.value)
                }
                className="mt-1 pl-2 block w-full rounded-md border border-gray-600 shadow-sm focus:border-[#8B0000] focus:ring-[#8B0000] h-10"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleWorkExperienceChange("present", "years", e.target.value)
                }
                className="mt-1 pl-2 block w-full rounded-md border border-gray-600 shadow-sm focus:border-[#8B0000] focus:ring-[#8B0000] h-10"
              />
            </div>
      ...
      <div className="border p-4 rounded-md bg-gray-50">
        <div className="flex justify-between items-center mb-3">
          <div className="flex items-center">
            ...
            <div className="ml-4 flex items-center">
              ...
              />
              <label
                htmlFor="no-teaching-experience"
        ...
        <div
          className="space-y-4"
          style={{ opacity: noTeachingExperience ? "0.5" : "1" }}
        >
              ...
              <div className="absolute top-3 right-3">
                {formData.teachingExperience.length > 1 && (
                  <button
                    ...
                    onClick={() => {
                      const updatedExperience =
                        formData.teachingExperience.filter(
                          (_, i) => i !== index
                        );
                      updateFormData({ teachingExperience: updatedExperience });
                    }}
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleTeachingExperienceChange(
                        index,
                        "institute",
                        e.target.value
                      )
