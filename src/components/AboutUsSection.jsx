...
const AboutUsSection = () => {
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-white to-[#680000]/5 px-4 md:px-0">
          ...
          >
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-[#680000] text-white p-6 rounded-lg shadow-lg max-w-xs hidden md:block">
                <p className="font-semibold text-xl mb-2">Excellence in Education</p>
                <p className="text-sm opacity-80">Join our community of learners and educators committed to academic excellence and innovation.</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-[#680000] hover:shadow-xl transition-shadow duration-300">
            <div className="w-12 h-12 bg-[#680000]/10 rounded-full flex items-center justify-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#680000]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p className="text-gray-600">Providing top-tier education with experienced faculty members and modern facilities.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-[#680000] hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Career Readiness</h3>
            <p className="text-gray-600">Preparing students for successful careers through practical education and industry partnerships.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-[#680000] hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="text-gray-600">Building a supportive learning community where students and faculty can collaborate and grow together.</p>
          </div>
        </motion.div>
      </div>
    </section>
