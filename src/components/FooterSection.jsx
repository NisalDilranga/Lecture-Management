  ...
  return (
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/4 mb-8 md:mb-0">
            ...
            >
              <a
                href="#"
                className="text-gray-400 hover:text-[#A52A2A] transition-colors"
              >
                <FaFacebook size={20} />
              </a>
              <a
          ...
          >
            <h3 className="text-xl font-semibold mb-4 text-[#A52A2A]">
              Quick Links
            </h3>
        ...
        >
          <p>
            &copy; {currentYear} Advanced Technology Institute . All rights
            reserved.
          </p>
        </motion.div>
      </div>
