...
const WhyChooseUsSection = () => {
  ...
  const itemVariants = {
    ...
    hover: {
      scale: 1.05,
      boxShadow: "0px 10px 20px rgba(139, 0, 0, 0.2)",
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              key={index}
              className="bg-[#ecf0f1] p-6 rounded-lg shadow-md flex flex-col items-center text-center"
