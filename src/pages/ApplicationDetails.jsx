...
const ApplicationDetails = () => {
  ...
  // Mock data function for testing or fallback
  const getMockApplicationData = (id) => {
    ...
    return {
      ...
      otherQualifications: "Fluent in three programming languages. Published research in top-tier journals.",
      teachingExperience: [
        {
  ...
  useEffect(() => {    const fetchApplicationDetails = async () => {
      try {
        setLoading(true);
        let applicationData = await getApplicationById(id);
        
        // If data is missing or limited (non-admin, non-owner view), use mock data
        if (!applicationData || !applicationData.fullName) {
          console.log("Limited or no data returned from Firebase, using mock data");
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">              <thead className="bg-gray-50">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {application.preferredPlacements && application.preferredPlacements.length > 0 ? (
        ...
        <div className="p-6">
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {application.academicQualifications && application.academicQualifications.length > 0 ? (
                  application.academicQualifications.map((qualification, index) => (
                    <tr key={index}>
        ...
        <div className="p-6">
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {application.professionalQualifications && application.professionalQualifications.length > 0 ? (
                  application.professionalQualifications.map((qualification, index) => (
                    <tr key={index}>
        ...
        <div className="p-6">
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {application.teachingExperience && application.teachingExperience.length > 0 ? (
        ...
        <div className="p-6">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {application.workExperience?.past && application.workExperience.past.length > 0 ? (
