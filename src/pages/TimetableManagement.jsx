  ...
  const [timetableData, setTimetableData] = useState([
    {
      day: "Monday",
      periods: [
        { time: "09:00-10:00", subject: "", room: "" },
        { time: "10:00-11:00", subject: "", room: "" },
        { time: "11:00-12:00", subject: "", room: "" },
        { time: "13:00-14:00", subject: "", room: "" },
        { time: "14:00-15:00", subject: "", room: "" },
      ],
    },
    {
      day: "Tuesday",
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const filteredUsers = allUsersFetched.filter(
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNewTimeSlotChange("time", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNewTimeSlotChange("subject", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleNewTimeSlotChange("room", e.target.value)
                    }
                  />
                </div>
              </div>
              ...
              <tbody>
                {timetableData
                  ...
                  .map((day, dayIndex) => {
                    ...
                    const originalDayIndex = timetableData.findIndex(
                      (d) => d.day === day.day
                    );
                    return (
                ...
                {timetableData.filter((day) => day.periods.length > 0)
                  .length === 0 && (
                  <tr>
