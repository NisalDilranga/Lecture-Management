      ...
      try {
        ...
        const mockApplications = [
          ...
          },
          {
            ...
            submittedAt: {
              seconds: (Date.now() - 3 * 24 * 60 * 60 * 1000) / 1000,
            },
            status: "approved",
          },
          {
            ...
            submittedAt: {
              seconds: (Date.now() - 5 * 24 * 60 * 60 * 1000) / 1000,
            },
            status: "rejected",
          },
        ];
    ...
    if (searchTerm) {
      ...
      filtered = filtered.filter(
        (app) =>
          ...
          app.preferredPlacements?.[0]?.place
            ?.toLowerCase()
                ...
                filteredApplications.map((app) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4">
                      {" "}
                      {app.preferredPlacements && app.preferredPlacements[0]
                        ? `${app.preferredPlacements[0].place || ""} - ${
                            Array.isArray(app.preferredPlacements[0].subjects)
